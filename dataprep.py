...
## ========== ===========
def extract(args):
	#[vox1_dev_wav.zip, vox1_test_wav.zip, vox2_dev_aac.zip]
	files = glob.glob('%s/*.zip'%args.save_path)

	vox1_train = args.save_path + '/voxceleb1/dev'
	vox1_test  = args.save_path + '/voxceleb1/test'
	dir_list = [vox1_train, vox1_test]
